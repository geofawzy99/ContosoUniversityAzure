...
{
    public partial interface IStoreRepository : IRepository<ContosoUniversity.DAL.SalesModel.Store>
    {
        ICollection<ContosoUniversity.DAL.SalesModel.Store> GetAll();
        ContosoUniversity.DAL.SalesModel.Store GetByKey(int _Id);
    }
}
