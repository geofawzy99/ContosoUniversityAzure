...
{
    public partial interface IItemStoreRepository : IRepository<ContosoUniversity.DAL.SalesModel.ItemStore>
    {
        ICollection<ContosoUniversity.DAL.SalesModel.ItemStore> GetAll();
        ContosoUniversity.DAL.SalesModel.ItemStore GetByKey(long _Id);
    }
}
