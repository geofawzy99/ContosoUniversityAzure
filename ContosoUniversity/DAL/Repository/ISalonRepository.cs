...
{
    public partial interface ISalonRepository : IRepository<ContosoUniversity.DAL.SalesModel.Salon>
    {
        ICollection<ContosoUniversity.DAL.SalesModel.Salon> GetAll();
        ContosoUniversity.DAL.SalesModel.Salon GetByKey(int _Id);
    }
}
