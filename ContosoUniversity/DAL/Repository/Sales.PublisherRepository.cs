...
{
    public partial class PublisherRepository : EntityFrameworkRepository<ContosoUniversity.DAL.SalesModel.Publisher>, IPublisherRepository
    {
        public PublisherRepository(ContosoUniversity.DAL.SalesModel.SalesContext context) : base(context)
        {
        }

        public virtual ICollection<ContosoUniversity.DAL.SalesModel.Publisher> GetAll()
        {
            return objectSet.ToList();
        }

        public virtual ContosoUniversity.DAL.SalesModel.Publisher GetByKey(int _Id)
        {
