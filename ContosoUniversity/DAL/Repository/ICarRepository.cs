...
{
    public partial interface ICarRepository : IRepository<ContosoUniversity.DAL.SalesModel.Car>
    {
        ICollection<ContosoUniversity.DAL.SalesModel.Car> GetAll();
        ContosoUniversity.DAL.SalesModel.Car GetByKey(int _Id);
    }
}
