...
{
    public partial class CarRepository : EntityFrameworkRepository<ContosoUniversity.DAL.SalesModel.Car>, ICarRepository
    {
        public CarRepository(ContosoUniversity.DAL.SalesModel.SalesContext context) : base(context)
        {
        }

        public virtual ICollection<ContosoUniversity.DAL.SalesModel.Car> GetAll()
        {
            return objectSet.ToList();
        }

        public virtual ContosoUniversity.DAL.SalesModel.Car GetByKey(int _Id)
        {
