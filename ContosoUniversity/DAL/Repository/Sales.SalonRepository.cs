...
{
    public partial class SalonRepository : EntityFrameworkRepository<ContosoUniversity.DAL.SalesModel.Salon>, ISalonRepository
    {
        public SalonRepository(ContosoUniversity.DAL.SalesModel.SalesContext context) : base(context)
        {
        }

        public virtual ICollection<ContosoUniversity.DAL.SalesModel.Salon> GetAll()
        {
            return objectSet.ToList();
        }

        public virtual ContosoUniversity.DAL.SalesModel.Salon GetByKey(int _Id)
        {
