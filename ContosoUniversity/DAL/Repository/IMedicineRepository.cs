...
{
    public partial interface IMedicineRepository : IRepository<ContosoUniversity.DAL.SalesModel.Medicine>
    {
        ICollection<ContosoUniversity.DAL.SalesModel.Medicine> GetAll();
        ContosoUniversity.DAL.SalesModel.Medicine GetByKey(long _Id);
    }
}
