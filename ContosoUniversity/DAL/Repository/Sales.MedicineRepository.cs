...
{
    public partial class MedicineRepository : EntityFrameworkRepository<ContosoUniversity.DAL.SalesModel.Medicine>, IMedicineRepository
    {
        public MedicineRepository(ContosoUniversity.DAL.SalesModel.SalesContext context) : base(context)
        {
        }

        public virtual ICollection<ContosoUniversity.DAL.SalesModel.Medicine> GetAll()
        {
            return objectSet.ToList();
        }

        public virtual ContosoUniversity.DAL.SalesModel.Medicine GetByKey(long _Id)
        {
