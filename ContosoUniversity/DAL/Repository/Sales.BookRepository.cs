...
{
    public partial class BookRepository : EntityFrameworkRepository<ContosoUniversity.DAL.SalesModel.Book>, IBookRepository
    {
        public BookRepository(ContosoUniversity.DAL.SalesModel.SalesContext context) : base(context)
        {
        }

        public virtual ICollection<ContosoUniversity.DAL.SalesModel.Book> GetAll()
        {
            return objectSet.ToList();
        }

        public virtual ContosoUniversity.DAL.SalesModel.Book GetByKey(long _Id)
        {
